...
import { ClientSentPacket, ServerSentPacket } from "./ddp-types.ts";

export type MethodHandler = (socket: InboundDdpSocket, params: unknown[]) => unknown | Promise<unknown>;
export type PublicationHandler = (socket: InboundDdpSocket, params: unknown[], stopSignal: AbortSignal) => void | Promise<void>;
